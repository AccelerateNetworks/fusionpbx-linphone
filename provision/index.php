<?php
if(strpos($_SERVER['HTTP_USER_AGENT'], "Linphone") !== false || strpos($_SERVER['HTTP_USER_AGENT'], "AN Mobile") !== false) {
...
<body>
	...
	<span class="desktop">
		...
		<p>2. <a id="click-to-provision" href="javascript: void(0);">Click here to configure linphone with your account</a>.</p>
	</span>
	...
	<script>
		...
		document.querySelector('#click-to-provision').setAttribute("href", provisioningURL);
	</script>
</body>
</html>
